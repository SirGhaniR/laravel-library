      ...
      <tbody>
        @foreach ($borrows as $borrow)
          <tr>
            ...
            <td>
              @if (isset($borrow->fine))
                <span class="btn btn-danger">{{ $borrow->fine }}</span>
              @else
            ...
            <td>
              @if (isset($borrow->return_borrow))
                <span class="btn btn-success">Book is returned</span>
              @elseif (!isset($borrow->return_borrow))
                <span class="btn btn-warning">Book is still being borrowed</span>
              @elseif ($borrow->return_borrow > $borrow->end_borrow)
                <span class="btn btn-danger">Late return by member</span>
              @endif
            </td>
